...
const Footer = () => {
  return (
    <footer
      className="fond-bold flex flex-col justify-center bg-primary font-mono text-lg text-white"
      id="footer">
        ...
        <nav aria-label="footer" className="hidden justify-between w-screen-sm md:flex">
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <Link className="hover:text-secondary" href="/#discover">
                  Discover
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <Link className="hover:text-secondary" href="/#techstack">
                  General
                </Link>
              </li>
              <li>
