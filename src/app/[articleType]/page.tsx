...
const ArticleFigure = ({ article }: ArticleFigureProps) => (
    <Link key={article.id} className="group pointer-events-auto" href={localArticleRoute(article.type.name, article.slug)}>
        <figure className="relative flex flex-col border-2 border-secondary dark:border-secondaryDark">
