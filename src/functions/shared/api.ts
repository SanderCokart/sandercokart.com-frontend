...
interface CustomAxiosInstance extends AxiosInstance {
  simpleGet<DATA = any, RESPONSE = CustomApiResponse<DATA>>(
    url: string,
    config?: CustomAxiosRequestConfig,
  ): Promise<RESPONSE>;

  simpleDelete<DATA = any, RESPONSE = CustomApiResponse<DATA>>(
    url: string,
    config?: CustomAxiosRequestConfig,
  ): Promise<RESPONSE>;

  simplePost<DATA = any, RESPONSE = CustomApiResponse<DATA>>(
    url: string,
    data?: any,
    config?: CustomAxiosRequestConfig,
  ): Promise<RESPONSE>;

  simplePut<DATA = any, RESPONSE = CustomApiResponse<DATA>>(
    url: string,
    data?: any,
    config?: CustomAxiosRequestConfig,
  ): Promise<RESPONSE>;

  simplePatch<DATA = any, RESPONSE = CustomApiResponse<DATA>>(
    url: string,
    data?: any,
    config?: CustomAxiosRequestConfig,
  ): Promise<RESPONSE>;
