    ...
    return (
        <section className="relative z-10 shadow-2xl">
            <h1 className={twJoin(
                ...
                'dark:bg-secondaryDark bg-secondary',
                'py-1 md:py-2',
            ...
            <div className="bg-bodyLightSecondary dark:border-secondaryDark dark:bg-bodyDarkSecondary relative border-secondary py-4 md:p-8">
                ...
                >
                    ...
                    <button
                        className={twJoin(
                            ...
                            'absolute z-10 cursor-pointer place-items-center text-white',
                            'disabled:pointer-events-none',
                            'dark:bg-primaryDark bg-primary disabled:bg-black',
