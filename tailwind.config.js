...
module.exports = {
  ...
  theme: {
    extend: {
      animation: {
        "ring-pulse-primary":
          "ring-pulse-primary 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite",
        "ring-pulse-secondary":
          "ring-pulse-secondary 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite",
      },
      keyframes: ({ theme }) => ({
        "ring-pulse-primary": {
      ...
      minHeight: ({ theme }) => ({
        ...
        mobile: `calc(100dvh - ${theme("spacing.nav-mobile")} - ${theme(
          "spacing.header-mobile",
        )})`,
      }),
      spacing: {
